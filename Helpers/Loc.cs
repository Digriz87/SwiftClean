...
namespace SwiftClean.Helpers
{
    ...
    public class Loc : INotifyPropertyChanged
    {
        ...
        private static readonly Dictionary<string, string> En = new()
        {
            ...
            // drivers
            ["drv.outdatedLabel"] = "outdated", ["drv.uptodateLabel"] = "up to date",
            ["drv.totalFmt"] = "{0} drivers", ["drv.scan"] = "Scan", ["drv.updateAll"] = "Update all",
            ["drv.update"] = "Update", ["drv.scanning"] = "Scanning drivers...",
            ["drv.checkingFmt"] = "Checking: {0}", ["drv.scanComplete"] = "Scan complete",
            ["drv.canUpdate"] = "Update available", ["drv.uptodate"] = "Up to date", ["drv.notchecked"] = "Not checked",
            ["drv.installing"] = "Installing...",
            ["drv.beta"] = "Under development — may work incorrectly.",
            ["drv.colDevice"] = "DEVICE", ["drv.colType"] = "TYPE", ["drv.colVersion"] = "VERSION",
            ["drv.colDate"] = "DATE", ["drv.colStatus"] = "STATUS",
            ["drv.empty1"] = "No drivers scanned yet", ["drv.empty2"] = "Click \"Scan\" to list your device drivers",
            ["drv.footer"] = "Driver updates are delivered through Windows Update.",
            ["drv.type.display"] = "Graphics", ["drv.type.net"] = "Network", ["drv.type.media"] = "Audio",
            ["drv.type.bluetooth"] = "Bluetooth", ["drv.type.image"] = "Imaging", ["drv.type.usb"] = "USB",
            ["drv.type.system"] = "System", ["drv.type.audioendpoint"] = "Audio", ["drv.type.monitor"] = "Monitor",
            ["drv.wuTitle"] = "Windows Update", ["drv.wuSearch"] = "Search WU",
            ["drv.wuInstall"] = "Install all", ["drv.wuSearching"] = "Searching Windows Update...",
            ["drv.wuNoUpdates"] = "All drivers are up to date", ["drv.wuFoundFmt"] = "{0} update(s) found",
            // scheduler
        ...
        private static readonly Dictionary<string, string> Ru = new()
        {
            ...
            ["title.drivers"] = "Обновление драйверов",
            ...
            // drivers
            ["drv.outdatedLabel"] = "устарело", ["drv.uptodateLabel"] = "актуально",
            ["drv.totalFmt"] = "{0} драйверов", ["drv.scan"] = "Сканировать", ["drv.updateAll"] = "Обновить все",
            ["drv.update"] = "Обновить", ["drv.scanning"] = "Сканирование драйверов...",
            ["drv.checkingFmt"] = "Проверка: {0}", ["drv.scanComplete"] = "Сканирование завершено",
            ["drv.canUpdate"] = "Можно обновить", ["drv.uptodate"] = "Актуально", ["drv.notchecked"] = "Не проверено",
            ["drv.installing"] = "Установка...",
            ["drv.beta"] = "В разработке — может работать неверно.",
            ["drv.colDevice"] = "УСТРОЙСТВО", ["drv.colType"] = "ТИП", ["drv.colVersion"] = "ВЕРСИЯ",
            ["drv.colDate"] = "ДАТА", ["drv.colStatus"] = "СТАТУС",
            ["drv.empty1"] = "Драйверы ещё не просканированы", ["drv.empty2"] = "Нажмите «Сканировать», чтобы увидеть драйверы устройств",
            ["drv.footer"] = "Обновления драйверов устанавливаются через Windows Update.",
            ["drv.type.display"] = "Видеокарта", ["drv.type.net"] = "Сеть", ["drv.type.media"] = "Аудио",
            ["drv.type.bluetooth"] = "Bluetooth", ["drv.type.image"] = "Камеры", ["drv.type.usb"] = "USB",
            ["drv.type.system"] = "Система", ["drv.type.audioendpoint"] = "Аудио", ["drv.type.monitor"] = "Монитор",
            ["drv.wuTitle"] = "Windows Update", ["drv.wuSearch"] = "Поиск обновлений",
            ["drv.wuInstall"] = "Установить все", ["drv.wuSearching"] = "Поиск в Windows Update...",
            ["drv.wuNoUpdates"] = "Все драйверы актуальны", ["drv.wuFoundFmt"] = "Найдено обновлений: {0}",
